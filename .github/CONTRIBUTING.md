# Contributing to StorageToolKit-iOS
...
In general, we expect you to follow our [Code of Conduct](https://github.com/gojek/StorageToolKit-iOS/blob/main/CODE_OF_CONDUCT.md).
...
1. [Fork](http://help.github.com/fork-a-repo/) the project, clone your fork, and configure the remotes:
   ...
   git clone git@github.com:YOUR_USERNAME/StorageToolKit-iOS.git
   # Navigate to the newly cloned directory
   cd StorageToolKit-iOS
   # Assign the original repo to a remote called "upstream"
   git remote add upstream git@github.com:gojek/StorageToolKit-iOS.git
   ```
...
license your work under the same license as that used by the project, which is available [here](https://github.com/gojek/StorageToolKit-iOS/blob/main/LICENSE.md).

### Discussions

We aim to keep all project discussions inside GitHub Issues. This is to make sure valuable discussion is accessible via search. If you have questions about how to use the library, or how the project is running - GitHub Issues are the go-to tool for this project.
